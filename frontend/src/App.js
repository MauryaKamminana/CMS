        ...
        <div className="app-container">
          ...
          <main className="main-content">
            <Routes>
              ...
              <Route path="/admin/courses/:id" element={<PrivateRoute role="admin"><CourseDetail /></PrivateRoute>} />
              <Route path="/admin/courses/:id/edit" element={<PrivateRoute role="admin"><EditCourse /></PrivateRoute>} />
              ...
              <Route path="/assignments/edit/:id" element={<PrivateRoute><EditAssignment /></PrivateRoute>} />
              <Route path="/assignments/:id/submit" element={<PrivateRoute><SubmitAssignment /></PrivateRoute>} />
              <Route path="/assignments/:id/submissions" element={<PrivateRoute><Submissions /></PrivateRoute>} />
              <Route path="/assignments/:assignmentId/submission/:submissionId" element={<SubmissionDetail />} />
              <Route path="/attendance" element={<PrivateRoute><Attendance /></PrivateRoute>} />
              <Route path="/attendance/mark" element={<PrivateRoute><MarkAttendance /></PrivateRoute>} />
              <Route path="/attendance/student" element={<PrivateRoute><StudentAttendance /></PrivateRoute>} />
              ...
              <Route path="/resources/new" element={<PrivateRoute><CreateResource /></PrivateRoute>} />
              <Route path="/resources/edit/:id" element={<PrivateRoute><EditResource /></PrivateRoute>} />
              <Route 
                path="/courses/:id" 
                element={
                  <PrivateRoute>
              ...
              />
              <Route path="/courses/:id/assignments" element={<PrivateRoute><CourseAssignments /></PrivateRoute>} />
              <Route path="/courses/:id/resources" element={<PrivateRoute><CourseResources /></PrivateRoute>} />
              <Route path="/courses/:id/attendance" element={<PrivateRoute><CourseAttendance /></PrivateRoute>} />
              <Route path="/courses/:id/attendance/mark" element={<PrivateRoute role="faculty"><MarkCourseAttendance /></PrivateRoute>} />
              <Route path="/courses/:id/students" element={<PrivateRoute role="faculty"><CourseStudents /></PrivateRoute>} />
