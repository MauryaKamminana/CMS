...
function Attendance() {
  ...
  const exportAttendance = async () => {
    ...
    try {
      ...
      link.setAttribute(
        "download",
        `attendance_${courseName}_${params.startDate}_to_${params.endDate}.csv`
      );
    ...
    <div className="attendance-container">
      <div className="attendance-header">
        ...
        <div className="attendance-actions">
          ...
          <button className="btn btn-secondary" onClick={toggleExport}>
            ...
            <tbody>
              {attendanceRecords.map((record) => (
                <tr key={record._id}>
                  ...
                  <td>
                    {record.course ? record.course.name : "course not existing"}
                  </td>
                  <td>
                    {
                  ...
                  <td>
                    {
                      (record.students || []).filter((s) => s.status === "late")
                        .length
                    }
                  </td>
                  <td>
